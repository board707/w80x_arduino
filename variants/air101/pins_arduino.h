// pin description for Air101 board
...
// pin mux macros for Air101
#define MUX_PA0 (NONE)      // Boot
...
#define MUX_PB6 (DIO)
#define MUX_PB7 (DIO)
#define MUX_PB8 (DIO)	//LED_BUILTIN1
#define MUX_PB9 (DIO)	//LED_BUILTIN2
#define MUX_PB10 (DIO)	//LED_BUILTIN3
#define MUX_PB11 (DIO)                      
