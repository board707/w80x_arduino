...
#define __HAL_RCC_SDIO_CLK_ENABLE()		SET_BIT(RCC->CLK_EN, RCC_CLK_EN_SDIO)

#define __HAL_RCC_SDIO_CLK_DISABLE()	CLEAR_BIT(RCC->CLK_EN, RCC_CLK_EN_SDIO)

#define __HAL_RCC_PSRAM_CLK_ENABLE() 	SET_BIT(RCC->CLK_EN, RCC_CLK_EN_QSRAM)

#define __HAL_RCC_PSRAM_CLK_DISABLE() 	CLEAR_BIT(RCC->CLK_EN, RCC_CLK_EN_QSRAM)
#endif