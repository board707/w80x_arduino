...
#define SDIO_BASE	(DEVICE_BASE_ADDR + 0x0A00)

typedef struct
{
	__IOM uint32_t CR;
	__IOM uint32_t IO;
	__IOM uint32_t BYTECNT;
	__IM  uint32_t TRBLOCKCNT;
	__IOM uint32_t CRCCTL;
	__IM  uint32_t CMDCRC;
	__IM  uint32_t DATACRCL;
	__IM  uint32_t DATACRCH;
	__IOM uint32_t PORT;
	__IOM uint32_t IM;
	__IOM uint32_t IF;
	__IOM uint32_t SEL;
	__IOM uint32_t SIG;
	__IOM uint32_t MBCTL;
	__IOM uint32_t BLOCKCNT;
	__IOM uint32_t TIMEOUT;
	__IOM uint32_t CMDBUF[16];
	__IOM uint32_t BUFCR;
	__IOM uint32_t RSV[31];
	__IOM uint32_t DATABUF[128];
} SDIO_TypeDef;

#define SDIO_CR_RDWAITEN_Pos				(10)
#define SDIO_CR_RDWAITEN_Msk				(0x01 << SDIO_CR_RDWAITEN_Pos)
#define SDIO_CR_RDWAITEN					SDIO_CR_RDWAITEN_Msk
#define SDIO_CR_IE_Pos						(9)
#define SDIO_CR_IE_Msk						(0x01 << SDIO_CR_IE_Pos)
#define SDIO_CR_IE							SDIO_CR_IE_Msk
#define SDIO_CR_MODE_Pos					(8)
#define SDIO_CR_MODE_Msk					(0x01 << SDIO_CR_MODE_Pos)
#define SDIO_CR_MODE						SDIO_CR_MODE_Msk
#define SDIO_CR_BUSWIDE_Pos					(7)
#define SDIO_CR_BUSWIDE_Msk					(0x01 << SDIO_CR_BUSWIDE_Pos)
#define SDIO_CR_BUSWIDE						SDIO_CR_BUSWIDE_Msk
#define SDIO_CR_HSPEED_Pos					(6)
#define SDIO_CR_HSPEED_Msk					(0x01 << SDIO_CR_HSPEED_Pos)
#define SDIO_CR_HSPEED						SDIO_CR_HSPEED_Msk
#define SDIO_CR_CLKSEL_Pos					(3)
#define SDIO_CR_CLKSEL_Msk					(0x07 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL						SDIO_CR_CLKSEL_Msk
#define SDIO_CR_CLKSEL_1_2					(0x00 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_4					(0x01 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_6					(0x02 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_8					(0x03 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_10					(0x04 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_12					(0x05 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_14					(0x06 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_CLKSEL_1_16					(0x07 << SDIO_CR_CLKSEL_Pos)
#define SDIO_CR_PINMODE_Pos					(2)
#define SDIO_CR_PINMODE_Msk					(0x01 << SDIO_CR_PINMODE_Pos)
#define SDIO_CR_PINMODE						SDIO_CR_PINMODE_Msk
#define SDIO_CR_SINGLEMODE_Pos				(1)
#define SDIO_CR_SINGLEMODE_Msk				(0x01 << SDIO_CR_SINGLEMODE_Pos)
#define SDIO_CR_SINGLEMODE					SDIO_CR_SINGLEMODE_Msk
#define SDIO_CR_PORTMODE_Pos				(0)
#define SDIO_CR_PORTMODE_Msk				(0x01 << SDIO_CR_PORTMODE_Pos)
#define SDIO_CR_PORTMODE					SDIO_CR_PORTMODE_Msk

#define SDIO_IO_CMD12_Pos					(9)
#define SDIO_IO_CMD12_Msk					(0x01 << SDIO_IO_CMD12_Pos)
#define SDIO_IO_CMD12						SDIO_IO_CMD12_Msk
#define SDIO_IO_CMDPARAM_Pos				(8)
#define SDIO_IO_CMDPARAM_Msk				(0x01 << SDIO_IO_CMDPARAM_Pos)
#define SDIO_IO_CMDPARAM					SDIO_IO_CMDPARAM_Msk
#define SDIO_IO_8NULLEN_Pos					(7)
#define SDIO_IO_8NULLEN_Msk					(0x01 << SDIO_IO_8NULLEN_Pos)
#define SDIO_IO_8NULLEN						SDIO_IO_8NULLEN_Msk
#define SDIO_IO_AUTORCVRSP_Pos				(6)
#define SDIO_IO_AUTORCVRSP_Msk				(0x01 << SDIO_IO_AUTORCVRSP_Pos)
#define SDIO_IO_AUTORCVRSP					SDIO_IO_AUTORCVRSP_Msk
#define SDIO_IO_8CLKNULL_Pos				(5)
#define SDIO_IO_8CLKNULL_Msk				(0x01 << SDIO_IO_8CLKNULL_Pos)
#define SDIO_IO_8CLKNULL					SDIO_IO_8CLKNULL_Msk
#define SDIO_IO_CIDCSD_Pos					(4)
#define SDIO_IO_CIDCSD_Msk					(0x01 << SDIO_IO_CIDCSD_Pos)
#define SDIO_IO_CIDCSD						SDIO_IO_CIDCSD_Msk
#define SDIO_IO_RCVRSP_Pos					(3)
#define SDIO_IO_RCVRSP_Msk					(0x01 << SDIO_IO_RCVRSP_Pos)
#define SDIO_IO_RCVRSP						SDIO_IO_RCVRSP_Msk
#define SDIO_IO_8CLKNULLEN_Pos				(2)
#define SDIO_IO_8CLKNULLEN_Msk				(0x01 << SDIO_IO_8CLKNULLEN_Pos)
#define SDIO_IO_8CLKNULLEN					SDIO_IO_8CLKNULLEN_Msk
#define SDIO_IO_RW_Pos						(1)
#define SDIO_IO_RW_Msk						(0x01 << SDIO_IO_RW_Pos)
#define SDIO_IO_RW							SDIO_IO_RW_Msk
#define SDIO_IO_AUTODATATR_Pos				(0)
#define SDIO_IO_AUTODATATR_Msk				(0x01 << SDIO_IO_AUTODATATR_Pos)
#define SDIO_IO_AUTODATATR					SDIO_IO_AUTODATATR_Msk

#define SDIO_BYTECNT_Pos					(0)
#define SDIO_BYTECNT_Msk					(0x0FFFF << SDIO_BYTECNT_Pos)
#define SDIO_BYTECNT						SDIO_BYTECNT_Msk

#define SDIO_TRBLOCKCNT_Pos					(0)
#define SDIO_TRBLOCKCNT_Msk					(0x0FFFF << SDIO_TRBLOCKCNT_Pos)
#define SDIO_TRBLOCKCNT						SDIO_TRBLOCKCNT_Msk

#define SDIO_CRCCTL_CMDCRCEN_Pos			(7)
#define SDIO_CRCCTL_CMDCRCEN_Msk			(0x01 << SDIO_CRCCTL_CMDCRCEN_Pos)
#define SDIO_CRCCTL_CMDCRCEN				SDIO_CRCCTL_CMDCRCEN_Msk
#define SDIO_CRCCTL_DATACRCEN_Pos			(6)
#define SDIO_CRCCTL_DATACRCEN_Msk			(0x01 << SDIO_CRCCTL_DATACRCEN_Pos)
#define SDIO_CRCCTL_DATACRCEN				SDIO_CRCCTL_DATACRCEN_Msk
#define SDIO_CRCCTL_CRCCHECKEN_Pos			(5)
#define SDIO_CRCCTL_CRCCHECKEN_Msk			(0x01 << SDIO_CRCCTL_CRCCHECKEN_Pos)
#define SDIO_CRCCTL_CRCCHECKEN				SDIO_CRCCTL_CRCCHECKEN_Msk
#define SDIO_CRCCTL_RDBEFORERSPEN_Pos		(4)
#define SDIO_CRCCTL_RDBEFORERSPEN_Msk		(0x01 << SDIO_CRCCTL_RDBEFORERSPEN_Pos)
#define SDIO_CRCCTL_RDBEFORERSPEN			SDIO_CRCCTL_RDBEFORERSPEN_Msk
#define SDIO_CRCCTL_DATACRCSEL_Pos			(2)
#define SDIO_CRCCTL_DATACRCSEL_Msk			(0x03 << SDIO_CRCCTL_DATACRCSEL_Pos)
#define SDIO_CRCCTL_DATACRCSEL				SDIO_CRCCTL_DATACRCSEL_Msk
#define SDIO_CRCCTL_CMDCRCERR_Pos			(1)
#define SDIO_CRCCTL_CMDCRCERR_Msk			(0x01 << SDIO_CRCCTL_CMDCRCERR_Pos)
#define SDIO_CRCCTL_CMDCRCERR				SDIO_CRCCTL_CMDCRCERR_Msk
#define SDIO_CRCCTL_DATACRCERR_Pos			(0)
#define SDIO_CRCCTL_DATACRCERR_Msk			(0x01 << SDIO_CRCCTL_DATACRCERR_Pos)
#define SDIO_CRCCTL_DATACRCERR				SDIO_CRCCTL_DATACRCERR_Msk

#define SDIO_CMDCRC_Pos						(0)
#define SDIO_CMDCRC_Msk						(0x07F << SDIO_CMDCRC_Pos)
#define SDIO_CMDCRC							SDIO_CMDCRC_Msk

#define SDIO_DATACRCL_Pos					(0)
#define SDIO_DATACRCL_Msk					(0x07F << SDIO_DATACRCL_Pos)
#define SDIO_DATACRCL						SDIO_DATACRCL_Msk

#define SDIO_DATACRCH_Pos					(0)
#define SDIO_DATACRCH_Msk					(0x07F << SDIO_DATACRCH_Pos)
#define SDIO_DATACRCH						SDIO_DATACRCH_Msk

#define SDIO_PORT_CLK_Pos					(7)
#define SDIO_PORT_CLK_Msk					(0x01 << SDIO_PORT_CLK_Pos)
#define SDIO_PORT_CLK						SDIO_PORT_CLK_Msk
#define SDIO_PORT_CMD_Pos					(6)
#define SDIO_PORT_CMD_Msk					(0x01 << SDIO_PORT_CMD_Pos)
#define SDIO_PORT_CMD						SDIO_PORT_CMD_Msk
#define SDIO_PORT_DATA_Pos					(5)
#define SDIO_PORT_DATA_Msk					(0x01 << SDIO_PORT_DATA_Pos)
#define SDIO_PORT_DATA						SDIO_PORT_DATA_Msk
#define SDIO_PORT_NCR_Pos					(4)
#define SDIO_PORT_NCR_Msk					(0x01 << SDIO_PORT_NCR_Pos)
#define SDIO_PORT_NCR						SDIO_PORT_NCR_Msk
#define SDIO_PORT_NCRTIMEOUT_Pos			(0)
#define SDIO_PORT_NCRTIMEOUT_Msk			(0x0F << SDIO_PORT_NCRTIMEOUT_Pos)
#define SDIO_PORT_NCRTIMEOUT				SDIO_PORT_NCRTIMEOUT_Msk

#define SDIO_IM_DATA1_Pos					(8)
#define SDIO_IM_DATA1_Msk					(0x01 << SDIO_IM_DATA1_Pos)
#define SDIO_IM_DATA1						SDIO_IM_DATA1_Msk
#define SDIO_IM_CRCTOKENERR_Pos				(7)
#define SDIO_IM_CRCTOKENERR_Msk				(0x01 << SDIO_IM_CRCTOKENERR_Pos)
#define SDIO_IM_CRCTOKENERR					SDIO_IM_CRCTOKENERR_Msk
#define SDIO_IM_NRCTIMEOUT_Pos				(6)
#define SDIO_IM_NRCTIMEOUT_Msk				(0x01 << SDIO_IM_NRCTIMEOUT_Pos)
#define SDIO_IM_NRCTIMEOUT					SDIO_IM_NRCTIMEOUT_Msk
#define SDIO_IM_BLKSTIMEOUT_Pos				(5)
#define SDIO_IM_BLKSTIMEOUT_Msk				(0x01 << SDIO_IM_BLKSTIMEOUT_Pos)
#define SDIO_IM_BLKSTIMEOUT					SDIO_IM_BLKSTIMEOUT_Msk
#define SDIO_IM_BLKSDONE_Pos				(4)
#define SDIO_IM_BLKSDONE_Msk				(0x01 << SDIO_IM_BLKSDONE_Pos)
#define SDIO_IM_BLKSDONE					SDIO_IM_BLKSDONE_Msk
#define SDIO_IM_CMDCRCERR_Pos				(3)
#define SDIO_IM_CMDCRCERR_Msk				(0x01 << SDIO_IM_CMDCRCERR_Pos)
#define SDIO_IM_CMDCRCERR					SDIO_IM_CMDCRCERR_Msk
#define SDIO_IM_DATACERR_Pos				(2)
#define SDIO_IM_DATACRCERR_Msk				(0x01 << SDIO_IM_DATACERR_Pos)
#define SDIO_IM_DATACRCERR					SDIO_IM_DATACRCERR_Msk
#define SDIO_IM_DATADONE_Pos				(1)
#define SDIO_IM_DATADONE_Msk				(0x01 << SDIO_IM_DATADONE_Pos)
#define SDIO_IM_DATADONE					SDIO_IM_DATADONE_Msk
#define SDIO_IM_CMDDONE_Pos					(0)
#define SDIO_IM_CMDDONE_Msk					(0x01 << SDIO_IM_CMDDONE_Pos)
#define SDIO_IM_CMDDONE						SDIO_IM_CMDDONE_Msk

#define SDIO_IF_DATA1_Pos					(8)
#define SDIO_IF_DATA1_Msk					(0x01 << SDIO_IF_DATA1_Pos)
#define SDIO_IF_DATA1						SDIO_IF_DATA1_Msk
#define SDIO_IF_CRCTOKENERR_Pos				(7)
#define SDIO_IF_CRCTOKENERR_Msk				(0x01 << SDIO_IF_CRCTOKENERR_Pos)
#define SDIO_IF_CRCTOKENERR					SDIO_IF_CRCTOKENERR_Msk
#define SDIO_IF_NRCTIMEOUT_Pos				(6)
#define SDIO_IF_NRCTIMEOUT_Msk				(0x01 << SDIO_IF_NRCTIMEOUT_Pos)
#define SDIO_IF_NRCTIMEOUT					SDIO_IF_NRCTIMEOUT_Msk
#define SDIO_IF_BLKSTIMEOUT_Pos				(5)
#define SDIO_IF_BLKSTIMEOUT_Msk				(0x01 << SDIO_IF_BLKSTIMEOUT_Pos)
#define SDIO_IF_BLKSDONE_Msk				(0x01 << SDIO_IF_BLKSDONE_Pos)
#define SDIO_IF_BLKSDONE					SDIO_IF_BLKSDONE_Msk
#define SDIO_IF_CMDCRCERR_Pos				(3)
#define SDIO_IF_BLKSTIMEOUT					SDIO_IF_BLKSTIMEOUT_Msk
#define SDIO_IF_BLKSDONE_Pos				(4)
#define SDIO_IF_CMDCRCERR_Msk				(0x01 << SDIO_IF_CMDCRCERR_Pos)
#define SDIO_IF_CMDCRCERR					SDIO_IF_CMDCRCERR_Msk
#define SDIO_IF_DATACERR_Pos				(2)
#define SDIO_IF_DATACRCERR_Msk				(0x01 << SDIO_IF_DATACERR_Pos)
#define SDIO_IF_DATACRCERR					SDIO_IF_DATACRCERR_Msk
#define SDIO_IF_DATADONE_Pos				(1)
#define SDIO_IF_DATADONE_Msk				(0x01 << SDIO_IF_DATADONE_Pos)
#define SDIO_IF_DATADONE					SDIO_IF_DATADONE_Msk
#define SDIO_IF_CMDDONE_Pos					(0)
#define SDIO_IF_CMDDONE_Msk					(0x01 << SDIO_IF_CMDDONE_Pos)
#define SDIO_IF_CMDDONE						SDIO_IF_CMDDONE_Msk

#define SDIO_SEL_CTRLEN_Pos					(7)
#define SDIO_SEL_CTRLEN_Msk					(0x01 << SDIO_SEL_CTRLEN_Pos)
#define SDIO_SEL_CTRLEN						SDIO_SEL_CTRLEN_Msk
#define SDIO_SEL_CLKEN_Pos					(6)
#define SDIO_SEL_CLKEN_Msk					(0x01 << SDIO_SEL_CLKEN_Pos)
#define SDIO_SEL_CLKEN						SDIO_SEL_CLKEN_Msk
#define SDIO_SEL_1MDIV_Pos					(0)
#define SDIO_SEL_1MDIV_Msk					(0x03F << SDIO_SEL_1MDIV_Pos)
#define SDIO_SEL_1MDIV						SDIO_SEL_1MDIV_Msk

#define SDIO_SIG_CMDLINESTS_Pos				(7)
#define SDIO_SIG_CMDLINESTS_Msk				(0x01 << SDIO_SIG_CMDLINESTS_Pos)
#define SDIO_SIG_CMDLINESTS					SDIO_SIG_CMDLINESTS_Msk
#define SDIO_SIG_CRCSTATUS_Pos				(4)
#define SDIO_SIG_CRCSTATUSS_Msk				(0x07 << SDIO_SIG_CRCSTATUS_Pos)
#define SDIO_SIG_CRCSTATUS					SDIO_SIG_CRCSTATUSS_Msk
#define SDIO_SIG_D3STATUS_Pos				(3)
#define SDIO_SIG_D3STATUSS_Msk				(0x01 << SDIO_SIG_D3STATUS_Pos)
#define SDIO_SIG_D3STATUS					SDIO_SIG_D3STATUSS_Msk
#define SDIO_SIG_D2STATUS_Pos				(2)
#define SDIO_SIG_D2STATUSS_Msk				(0x01 << SDIO_SIG_D2STATUS_Pos)
#define SDIO_SIG_D2STATUS					SDIO_SIG_D2STATUSS_Msk
#define SDIO_SIG_D1STATUS_Pos				(1)
#define SDIO_SIG_D1STATUSS_Msk				(0x01 << SDIO_SIG_D1STATUS_Pos)
#define SDIO_SIG_D1STATUS					SDIO_SIG_D1STATUSS_Msk
#define SDIO_SIG_D0STATUS_Pos				(0)
#define SDIO_SIG_D0STATUSS_Msk				(0x01 << SDIO_SIG_D0STATUS_Pos)
#define SDIO_SIG_D0STATUS					SDIO_SIG_D0STATUSS_Msk

#define SDIO_MBCTL_NACTIMEOUT_Pos			(6)
#define SDIO_MBCTL_NACTIMEOUT_Msk			(0x03 << SDIO_MBCTL_NACTIMEOUT_Pos)
#define SDIO_MBCTL_NACTIMEOUT				SDIO_MBCTL_NACTIMEOUT_Msk
#define SDIO_MBCTL_BUSYTIMEOUT_Pos			(4)
#define SDIO_MBCTL_BUSYTIMEOUT_Msk			(0x03 << SDIO_MBCTL_BUSYTIMEOUT_Pos)
#define SDIO_MBCTL_BUSYTIMEOUT				SDIO_MBCTL_BUSYTIMEOUT_Msk
#define SDIO_MBCTL_CLKPOLARITY_Pos			(3)
#define SDIO_MBCTL_CLKPOLARITY_Msk			(0x01 << SDIO_MBCTL_CLKPOLARITY_Pos)
#define SDIO_MBCTL_CLKPOLARITY				SDIO_MBCTL_CLKPOLARITY_Msk
#define SDIO_MBCTL_AUTOTRANSFER_Pos			(2)
#define SDIO_MBCTL_AUTOTRANSFER_Msk			(0x01 << SDIO_MBCTL_AUTOTRANSFER_Pos)
#define SDIO_MBCTL_AUTOTRANSFER				SDIO_MBCTL_AUTOTRANSFER_Msk
#define SDIO_MBCTL_BLKTRANSDIR_Pos			(1)
#define SDIO_MBCTL_BLKTRANSDIR_Msk			(0x01 << SDIO_MBCTL_BLKTRANSDIR_Pos)
#define SDIO_MBCTL_BLKTRANSDIR				SDIO_MBCTL_BLKTRANSDIR_Msk
#define SDIO_MBCTL_BLKSAUTOTREN_Pos			(0)
#define SDIO_MBCTL_BLKSAUTOTREN_Msk			(0x01 << SDIO_MBCTL_BLKSAUTOTREN_Pos)
#define SDIO_MBCTL_BLKSAUTOTREN				SDIO_MBCTL_BLKSAUTOTREN_Msk

#define SDIO_BLOCKCNT_Pos					(0)
#define SDIO_BLOCKCNT_Msk					(0x0FFFF << SDIO_BLOCKCNT_Pos)
#define SDIO_BLOCKCNT						SDIO_BLOCKCNT_Msk

#define SDIO_TIMEOUT_Pos					(0)
#define SDIO_TIMEOUT_Msk					(0x0FF << SDIO_TIMEOUT_Pos)
#define SDIO_TIMEOUT						SDIO_TIMEOUT_Msk

#define SDIO_CMDBUF_Pos						(0)
#define SDIO_CMDBUF_Msk						(0x0FF << SDIO_CMDBUF_Pos)
#define SDIO_CMDBUF							SDIO_CMDBUF_Msk

#define SDIO_BUFCR_DATACLR_Pos				(15)
#define SDIO_BUFCR_DATACLR_Msk				(0x01 << SDIO_BUFCR_DATACLR_Pos)
#define SDIO_BUFCR_DATACLR					SDIO_BUFCR_DATACLR_Msk
#define SDIO_BUFCR_DMAREQUEST_Pos			(14)
#define SDIO_BUFCR_DMAREQUEST_Msk			(0x01 << SDIO_BUFCR_DMAREQUEST_Pos)
#define SDIO_BUFCR_DMAREQUEST				SDIO_BUFCR_DMAREQUEST_Msk
#define SDIO_BUFCR_FIFOSTATUSEN_Pos			(12)
#define SDIO_BUFCR_FIFOSTATUSEN_Msk			(0x01 << SDIO_BUFCR_FIFOSTATUSEN_Pos)
#define SDIO_BUFCR_FIFOSTATUSEN				SDIO_BUFCR_FIFOSTATUSEN_Msk
#define SDIO_BUFCR_FIFODIR_Pos				(11)
#define SDIO_BUFCR_FIFODIR_Msk				(0x01 << SDIO_BUFCR_FIFODIR_Pos)
#define SDIO_BUFCR_FIFODIR					SDIO_BUFCR_FIFODIR_Msk
#define SDIO_BUFCR_DMAEN_Pos				(10)
#define SDIO_BUFCR_DMAEN_Msk				(0x01 << SDIO_BUFCR_DMAEN_Pos)
#define SDIO_BUFCR_DMAEN					SDIO_BUFCR_DMAEN_Msk
#define SDIO_BUFCR_FIFOLEVEL_Pos			(2)
#define SDIO_BUFCR_FIFOLEVEL_Msk			(0x0FF << SDIO_BUFCR_FIFOLEVEL_Pos)
#define SDIO_BUFCR_FIFOLEVEL				SDIO_BUFCR_FIFOLEVEL_Msk
#define SDIO_BUFCR_FIFOEMPTY_Pos			(1)
#define SDIO_BUFCR_FIFOEMPTY_Msk			(0x01 << SDIO_BUFCR_FIFOEMPTY_Pos)
#define SDIO_BUFCR_FIFOEMPTY				SDIO_BUFCR_FIFOEMPTY_Msk
#define SDIO_BUFCR_FIFOFULL_Pos				(0)
#define SDIO_BUFCR_FIFOFULL_Msk				(0x01 << SDIO_BUFCR_FIFOFULL_Pos)
#define SDIO_BUFCR_FIFOFULL					SDIO_BUFCR_FIFOFULL_Msk
...
#define RCC_RST_SDIOM_Pos					(27)
#define RCC_RST_SDIOM_Msk            		(0x1 << RCC_RST_SDIOM_Pos)
#define RCC_RST_SDIOM                		RCC_RST_SDIOM_Msk
