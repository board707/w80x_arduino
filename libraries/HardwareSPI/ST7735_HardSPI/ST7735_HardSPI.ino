...
// Выводы по дефолту. Можно другие, см даташит куда еще мультиплексируется
// контроллер SPI.
...
void setup() {
  ...
  sSPI.beginTransaction(SPISettings(20000000)); // Запускаем SPI на частоте 20 Мгц
