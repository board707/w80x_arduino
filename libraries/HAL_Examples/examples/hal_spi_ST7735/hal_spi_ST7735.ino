...
#define miso  GPIO_PIN_25
#define mosi  GPIO_PIN_26
#define clk   GPIO_PIN_24
...
{
  ST7735_SELECT;
  HAL_SPI_Transmit(&hspi, &data,1,4);
  ST7735_UNSELECT;
}
...
void SPI_Init(void)
{
  ...
  // Назначение выводов для SPI
  //__HAL_AFIO_REMAP_SPI_CS(GPIOB, LCD_CS);
    __HAL_AFIO_REMAP_SPI_CLK(GPIOB, clk);
    __HAL_AFIO_REMAP_SPI_MISO(GPIOB, miso);
    __HAL_AFIO_REMAP_SPI_MOSI(GPIOB, mosi);
  ...
  // Максимальная частота шины 20 Мгц
